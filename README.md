...
Built a Bronze, Silver, Gold data pipeline in Databricks using PySpark and Delta Lake to ingest, clean, and analyze NYC taxi trip data.
...
pickup_date
pickup_hour
Joins with taxi zone data to add:
pickup and dropoff borough and zone
Writes a cleaned fact table:
